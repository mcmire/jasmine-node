...
// Helper function to require a file that may be a JavaScript file or a
// CoffeeScript file. If we are requiring a CoffeeScript file, then we load the
// coffee-script module automatically.
//
jasmineNode.require = function(file) {
...
jasmineNode.loadHelpers = function(dir, pattern) {
  ...
  helpers.forEach(function(file) {
    var helper = jasmineNode.require(file);
