...
var helperPattern = new RegExp("(?:_h|-h|H)elper\.(?:"+extensions.join("|")+")$")
jasmineNode.loadHelpers(specsDir, helperPattern);
...
jasmineNode.executeSpecs(files, specPattern, {
  ...
  onComplete: function(runner, log) {
    sys.print('\n');
    // Ensure that stdout is flushed to the console.
    // This is far from the best solution since it's vulnerable to a race
    // condition, but I don't think this problem has been addressed just yet.
    // See:
